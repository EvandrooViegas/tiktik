        ...
        <div className='w-full'>
            <div className='flex gap-6 md:gap-10 mb-4 bg-white w-full'>
                    ...
                    <div className='flex flex-col justify-center'>
                        <p className='md:text-2xl items-center justify-center tracking-wider flex gap-1 items-center text-md font-bold text-primary lowercase'>
...
export const getServerSideProps = async ({params: id} : {params: {id: string}}) => {
    ...
    const res = await axios.get(`${BASE_URL}/api/profile/${id.id}`)
    return {
        props: {data: res.data}
    }    

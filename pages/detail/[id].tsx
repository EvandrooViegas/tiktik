...
function Detail({postDetails} : Iprops) {
  ...
  const addComment : any = async (e) => {
    ...
    return (
    <div className='flex w-full absolute absolut left-0 top-0 bg-white flex-wrap lg:flex-nowrap'>
          ...
          <div>
            <div className='relative'>
              <div className='lg:h-[100vh] h-[60vh]'>
                <video src={post.video.asset.url} className="h-full" loop ref={videoRef} onClick={onVideoClick}></video>
              </div>

              <div className='absolute top-[45%] left-[45%] cursor-pointer'>
                {!playing && (
                  <button onClick={onVideoClick}>
                    <BsFillPlayFill className='text-white text-6xl lg:text-8-l'/>
                  </button>
                )}
              </div>
            </div>

...
const VideoCard: NextPage<IProps> = ({ post }) => {
    ...
    const [isVideoMuted, setIsVideosMuted] = useState(false)
  ...
  return (
    <div className='flex flex-col border-b-2 border-gray-200 pb-6'>
        ...
        <div className='lg:ml-2 flex gap-4 relative'>
            <div className='rounded-3x1' onMouseEnter={() => {setIsHover(true)}} onMouseLeave={() => {setIsHover(false)}}>
                ...
                {isHover && (
                    ...
                    <div className='absolute bottom-6 cursor-pointer left-8 md:left-14 lg:left-0 flex gap-10 lg:justify-between w-[100px] md:w-[50px] p-3'>
                        ...
                        {
                            isVideoMuted ? 
                            <button onClick={() => setIsVideosMuted(false)}>
                                <HiVolumeOff className='text-black text-2xl lg:text-4xl'/>
                            </button> : 
                            <button onClick={() => setIsVideosMuted(true)}>
